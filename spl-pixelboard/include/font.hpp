...
// The least significant bit of each byte represents the leftmost pixel
const uint8_t font5x7[] = {
    ...
    // G (ASCII 71)
    0x3E, 0x41, 0x41, 0x49, 0x7A, 0x00, 0x00,
    // H (ASCII 72)
...
inline const uint8_t* getCharData(char c) {
    if (c < 32 || c > 90) {
        return &font5x7[0]; // Return space character for invalid characters
    }
